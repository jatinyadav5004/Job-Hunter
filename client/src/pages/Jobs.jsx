...
import { Search, Filter, RefreshCw, Briefcase, Sparkles, CheckCircle2, Bookmark, Flame } from 'lucide-react';
        ...
        <div className="flex flex-col sm:flex-row flex-wrap items-stretch sm:items-center gap-2.5 w-full lg:w-auto">
          ...
          <div className="relative flex-1 min-w-[200px] w-full sm:w-auto">
            ...
            <input
              ...
              className="w-full pl-9 pr-3 py-2 bg-slate-50 border border-slate-200 rounded-xl text-xs focus:outline-none focus:ring-2 focus:ring-teal-500 focus:bg-white transition-all"
            />
          </div>
          ...
          <div className="flex items-center gap-2">
            ...
            <select
              ...
              className="flex-1 sm:flex-initial px-3 py-2 bg-slate-50 border border-slate-200 rounded-xl text-xs font-semibold text-slate-700 focus:outline-none focus:ring-2 focus:ring-teal-500"
            >
            ...
            <button
              ...
              className="p-2 bg-slate-50 hover:bg-slate-100 border border-slate-200 rounded-xl text-slate-600 transition-colors shrink-0"
            >
